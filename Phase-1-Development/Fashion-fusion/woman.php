...
<head> 
    ...
    <title>Fashion Fusion | Women's Collection</title>
...
<body>  
    ...
    <div class="page-header">
        <h1>Women's <span class="text-primary">Fashion</span></h1>
        <hr class="divider">
    </div>
        ...
        <div class="container">
            <div class="products-container">
                ...
                if(isset($con)) {
                    ...
                    // Fetching from the women's products table
                ...
                <?php
                        ...
                        echo "<div class='no-products'><p>No items currently available in the Women's collection. Check back soon!</p></div>";
                    }
                } else {
