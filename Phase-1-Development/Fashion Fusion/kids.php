...
<head> 
    ...
    <title>Fashion Fusion | Kid's Collection</title>
...
<body>  
    ...
    <div class="page-header">
        <h1>Kid's <span class="text-primary">Fashion</span></h1>
        <hr class="divider">
    </div>
        ...
        <div class="container">
            <div class="products-container">
                ...
                <?php
                        ...
                        echo "<div class='no-products'><p>No items currently available in the Kid's collection. Check back soon!</p></div>";
                    }
                } else {
